...
export const SUGGESTION_CONTEXTS: Record<string, QueryContext> = {
  ...
  'Find all specialty pharmacies in California': c({
    ...
    stats: [{ label: 'CA Specialty', value: '512', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Los Angeles', value: '94', color: '#449055', bg: '#ECFDF5' }, { label: 'San Diego', value: '67', color: '#449055', bg: '#ECFDF5' }, { label: 'San Francisco', value: '58', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'Oncology', value: 128, color: '#DC2626' }, { name: 'Infusion', value: 96, color: '#005C8D' }, { name: 'Rare Disease', value: 74, color: '#76C799' }, { name: 'Other', value: 214, color: '#94A3B8' }], pieLabel: 'Specialty Focus (CA)',
    ...
    chatInsights: [{ icon: 'stat', text: '512 specialty pharmacies in California', color: '#449055' }, { icon: 'location', text: 'Los Angeles metro: 94 facilities', color: '#005C8D' }, { icon: 'warning', text: '3 DEA expirations within 30 days', color: '#D97706' }],
  }),
  ...
  'Look up pharmacy by NCPDP ID 0512345': c({
    ...
    stats: [{ label: 'NCPDP ID', value: '0512345', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Profile Score', value: '94', color: '#449055', bg: '#ECFDF5' }, { label: 'Credentials', value: '4', color: '#334155', bg: '#F8FAFC' }, { label: 'Networks', value: '5', color: '#005C8D', bg: '#E8F3F9' }],
    ...
    pieData: [{ name: 'Active', value: 4, color: '#449055' }], pieLabel: 'Credential Status',
    ...
    chatInsights: [{ icon: 'stat', text: 'Option Care Health — Los Angeles, CA', color: '#449055' }, { icon: 'info', text: 'DEA Valid · Specialty · 5 networks', color: '#005C8D' }],
  }),
  ...
  'Show 24/7 pharmacies near Houston, TX': c({
    ...
    stats: [{ label: '24/7 Pharmacies', value: '38', color: '#449055', bg: '#ECFDF5' }, { label: 'Houston Metro', value: 'TX', color: '#005C8D', bg: '#E8F3F9' }, { label: 'DEA Valid', value: '100%', color: '#449055', bg: '#ECFDF5' }, { label: 'Avg Networks', value: '6.3', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Retail', value: 32, color: '#005C8D' }, { name: 'Specialty', value: 4, color: '#76C799' }, { name: 'Compounding', value: 2, color: '#F59E0B' }], pieLabel: '24/7 Pharmacy Types',
    ...
    chatInsights: [{ icon: 'stat', text: '38 pharmacies open 24/7 in Houston metro', color: '#449055' }, { icon: 'location', text: 'CVS (14) and Walgreens (12) lead', color: '#005C8D' }, { icon: 'info', text: 'All have valid DEA registrations', color: '#449055' }],
  }),
  ...
  'List compounding pharmacies in Texas': c({
    ...
    stats: [{ label: 'TX Compounding', value: '347', color: '#449055', bg: '#ECFDF5' }, { label: 'Sterile', value: '142', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Non-Sterile', value: '205', color: '#D97706', bg: '#FFF7ED' }, { label: 'Houston', value: '89', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Sterile', value: 142, color: '#005C8D' }, { name: 'Non-Sterile', value: 205, color: '#76C799' }], pieLabel: 'Compounding Type (TX)',
    ...
    chatInsights: [{ icon: 'stat', text: '347 compounding pharmacies in Texas', color: '#449055' }, { icon: 'location', text: 'Houston leads with 89 facilities', color: '#005C8D' }, { icon: 'info', text: '142 sterile + 205 non-sterile', color: '#005C8D' }],
  }),
  ...
  'Show compounding pharmacies in Virginia': c({
    ...
    stats: [{ label: 'VA Compounding', value: '124', color: '#449055', bg: '#ECFDF5' }, { label: 'Richmond', value: '28', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Arlington', value: '22', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Sterile', value: '48', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Sterile', value: 48, color: '#005C8D' }, { name: 'Non-Sterile', value: 76, color: '#76C799' }], pieLabel: 'Compounding Type (VA)',
    ...
    chatInsights: [{ icon: 'stat', text: '124 compounding pharmacies in Virginia', color: '#449055' }, { icon: 'location', text: 'Richmond leads with 28 facilities', color: '#005C8D' }],
  }),
  ...
  'Generate a DEA expiry report for Q1 2026': c({
    ...
    pieData: [{ name: 'Retail', value: 680, color: '#005C8D' }, { name: 'Specialty', value: 340, color: '#76C799' }, { name: 'LTC', value: 160, color: '#F59E0B' }], pieLabel: 'Expiring by Type',
    ...
    chatInsights: [{ icon: 'warning', text: '1,180 pharmacies with DEA expiring Q1 2026', color: '#DC2626' }, { icon: 'info', text: 'February has the highest count: 420', color: '#005C8D' }],
  }),
  ...
  'Export all specialty pharmacies as Excel': c({
    ...
    stats: [{ label: 'Specialty Total', value: '4,820', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Format', value: 'Excel', color: '#449055', bg: '#ECFDF5' }, { label: 'File Size', value: '~18 MB', color: '#334155', bg: '#F8FAFC' }, { label: 'States', value: '50', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Oncology', value: 1200, color: '#DC2626' }, { name: 'Infusion', value: 980, color: '#005C8D' }, { name: 'Rare Disease', value: 640, color: '#76C799' }, { name: 'Other', value: 2000, color: '#94A3B8' }], pieLabel: 'Specialty Types',
    ...
    chatInsights: [{ icon: 'stat', text: '4,820 specialty pharmacies across 50 states', color: '#449055' }, { icon: 'info', text: 'Includes DEA, license, FWA, network data', color: '#005C8D' }],
  }),
  ...
  'Build a network coverage report for the Southwest': c({
    ...
    stats: [{ label: 'AZ Adequacy', value: '98.4%', color: '#449055', bg: '#ECFDF5' }, { label: 'NM Adequacy', value: '88.1%', color: '#DC2626', bg: '#FEF2F2' }, { label: 'TX Adequacy', value: '102.9%', color: '#449055', bg: '#ECFDF5' }, { label: 'NV Adequacy', value: '91.2%', color: '#D97706', bg: '#FFF7ED' }],
    barData: [{ label: 'TX', value: 8640 }, { label: 'AZ', value: 1890 }, { label: 'NV', value: 1420 }, { label: 'NM', value: 980 }], barLabel: 'Pharmacy Count (Southwest)',
    pieData: [{ name: 'Exceeds', value: 2, color: '#449055' }, { name: 'Meets', value: 1, color: '#005C8D' }, { name: 'Below', value: 1, color: '#DC2626' }], pieLabel: 'Adequacy Status',
    ...
    chatInsights: [{ icon: 'warning', text: 'New Mexico at 88.1% — below 90% threshold', color: '#DC2626' }, { icon: 'stat', text: 'TX and AZ exceed adequacy requirements', color: '#449055' }],
  }),
  ...
  'Generate monthly compliance summary as PDF': c({
    ...
    stats: [{ label: 'Overall', value: '94/100', color: '#449055', bg: '#ECFDF5' }, { label: 'DEA', value: '98%', color: '#449055', bg: '#ECFDF5' }, { label: 'FWA', value: '90%', color: '#D97706', bg: '#FFF7ED' }, { label: 'License', value: '99%', color: '#449055', bg: '#ECFDF5' }],
    barData: [{ label: 'DEA', value: 98 }, { label: 'FWA', value: 90 }, { label: 'License', value: 99 }, { label: 'Accred', value: 94 }], barLabel: 'Compliance Scores (%)',
    pieData: [{ name: 'Pass', value: 3, color: '#449055' }, { name: 'Warning', value: 1, color: '#F59E0B' }], pieLabel: 'Standards Status',
    ...
    chatInsights: [{ icon: 'stat', text: 'Overall compliance: 94/100', color: '#449055' }, { icon: 'warning', text: 'FWA attestation at 90% — review needed', color: '#D97706' }],
  }),
  ...
  'Create a custom dataset of LTC pharmacies by state': c({
    ...
    stats: [{ label: 'LTC Total', value: '3,420', color: '#005C8D', bg: '#E8F3F9' }, { label: 'CA', value: '412', color: '#449055', bg: '#ECFDF5' }, { label: 'TX', value: '358', color: '#449055', bg: '#ECFDF5' }, { label: 'FL', value: '296', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'CA', value: 412, color: '#005C8D' }, { name: 'TX', value: 358, color: '#76C799' }, { name: 'FL', value: 296, color: '#F59E0B' }, { name: 'Other', value: 2354, color: '#94A3B8' }], pieLabel: 'LTC Distribution',
    ...
    chatInsights: [{ icon: 'stat', text: '3,420 LTC pharmacies in database', color: '#449055' }, { icon: 'location', text: 'CA (412), TX (358), FL (296) are top 3', color: '#005C8D' }],
  }),
  ...
  'How many compounding pharmacies are in California?': c({
    ...
    stats: [{ label: 'CA Compounding', value: '512', color: '#449055', bg: '#ECFDF5' }, { label: 'Sterile', value: '198', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Non-Sterile', value: '314', color: '#D97706', bg: '#FFF7ED' }, { label: 'LA County', value: '124', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Sterile', value: 198, color: '#005C8D' }, { name: 'Non-Sterile', value: 314, color: '#76C799' }], pieLabel: 'Compounding Type (CA)',
    ...
    chatInsights: [{ icon: 'stat', text: '512 compounding pharmacies in California', color: '#449055' }, { icon: 'location', text: 'LA County: 124 — largest concentration', color: '#005C8D' }],
  }),
  ...
  'Find sterile compounding pharmacies near Houston': c({
    ...
    stats: [{ label: 'Sterile (Houston)', value: '42', color: '#449055', bg: '#ECFDF5' }, { label: 'DEA Valid', value: '100%', color: '#449055', bg: '#ECFDF5' }, { label: 'ACHC', value: '28', color: '#005C8D', bg: '#E8F3F9' }, { label: 'PCAB', value: '18', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Oncology', value: 14, color: '#DC2626' }, { name: 'Pain Mgmt', value: 12, color: '#F59E0B' }, { name: 'Hormone', value: 10, color: '#76C799' }, { name: 'Other', value: 6, color: '#94A3B8' }], pieLabel: 'Sterile Specialization',
    ...
    chatInsights: [{ icon: 'stat', text: '42 sterile compounding in Houston metro', color: '#449055' }, { icon: 'info', text: '28 ACHC accredited, 18 PCAB certified', color: '#005C8D' }],
  }),
  ...
  'Which states have the most compounding pharmacies?': c({
    ...
    stats: [{ label: 'US Total', value: '2,840', color: '#005C8D', bg: '#E8F3F9' }, { label: '#1 CA', value: '512', color: '#449055', bg: '#ECFDF5' }, { label: '#2 TX', value: '347', color: '#449055', bg: '#ECFDF5' }, { label: '#3 FL', value: '296', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'CA', value: 512, color: '#005C8D' }, { name: 'TX', value: 347, color: '#76C799' }, { name: 'FL', value: 296, color: '#F59E0B' }, { name: 'NY', value: 231, color: '#DC2626' }, { name: 'Other', value: 1454, color: '#94A3B8' }], pieLabel: 'National Share',
    ...
    chatInsights: [{ icon: 'stat', text: '2,840 compounding pharmacies in the US', color: '#449055' }, { icon: 'location', text: 'CA (512), TX (347), FL (296) are top 3', color: '#005C8D' }],
  }),
  ...
  'Run a full compliance audit across all networks': c({
    ...
    pieData: [{ name: 'Pass', value: 4, color: '#449055' }, { name: 'Warning', value: 1, color: '#F59E0B' }], pieLabel: 'Audit Status',
    ...
    chatInsights: [{ icon: 'stat', text: 'Overall compliance: 94/100', color: '#449055' }, { icon: 'warning', text: 'FWA attestation at 90% — below target', color: '#D97706' }],
  }),
  ...
  'Show pharmacies with DEA expiring in 30 days': c({
    ...
    pieData: [{ name: 'Specialty', value: 42, color: '#005C8D' }, { name: 'Retail', value: 28, color: '#76C799' }, { name: 'LTC', value: 12, color: '#F59E0B' }, { name: 'Other', value: 7, color: '#94A3B8' }], pieLabel: 'Expiring by Type',
    ...
    chatInsights: [{ icon: 'warning', text: '89 DEA expirations within 30 days', color: '#DC2626' }, { icon: 'location', text: 'TX leads with 24 expirations', color: '#005C8D' }],
  }),
  ...
  'Which pharmacies have expired state licenses?': c({
    ...
    pieData: [{ name: 'Retail', value: 210, color: '#005C8D' }, { name: 'Independent', value: 142, color: '#76C799' }, { name: 'Specialty', value: 86, color: '#F59E0B' }, { name: 'Other', value: 52, color: '#94A3B8' }], pieLabel: 'Expired by Type',
    ...
    chatInsights: [{ icon: 'warning', text: '490 pharmacies with expired state licenses', color: '#DC2626' }, { icon: 'location', text: 'FL leads with 82 expired', color: '#005C8D' }],
  }),
  ...
  'What is our overall compliance audit score?': c({
    ...
    pieData: [{ name: 'Pass', value: 3, color: '#449055' }, { name: 'Warning', value: 1, color: '#F59E0B' }], pieLabel: 'Audit Status',
    ...
    chatInsights: [{ icon: 'stat', text: 'Overall compliance: 94/100', color: '#449055' }, { icon: 'warning', text: 'FWA at 90% — needs attention', color: '#D97706' }],
  }),
  ...
  'Show credential gaps by state': c({
    ...
    stats: [{ label: 'Below Threshold', value: '6', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Worst Gap', value: 'MT 22%', color: '#DC2626', bg: '#FEF2F2' }, { label: 'States OK', value: '44', color: '#449055', bg: '#ECFDF5' }, { label: 'National Avg', value: '94.2%', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'Above 95%', value: 32, color: '#449055' }, { name: '90-95%', value: 12, color: '#005C8D' }, { name: 'Below 90%', value: 6, color: '#DC2626' }], pieLabel: 'State Distribution',
    ...
    chatInsights: [{ icon: 'warning', text: '6 states below 90% credential threshold', color: '#DC2626' }, { icon: 'stat', text: '44 states meet requirements — 94.2% national avg', color: '#449055' }],
  }),
  ...
  'Show recent ownership changes this month': c({
    ...
    stats: [{ label: 'This Month', value: '18', color: '#D97706', bg: '#FFF7ED' }, { label: 'High Priority', value: '4', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Processed', value: '12', color: '#449055', bg: '#ECFDF5' }, { label: 'Pending', value: '6', color: '#D97706', bg: '#FFF7ED' }],
    ...
    pieData: [{ name: 'Processed', value: 12, color: '#449055' }, { name: 'Under Review', value: 4, color: '#F59E0B' }, { name: 'Pending', value: 2, color: '#DC2626' }], pieLabel: 'CHOW Status',
    ...
    chatInsights: [{ icon: 'warning', text: '18 ownership changes this month — 4 high priority', color: '#D97706' }, { icon: 'stat', text: '12 processed, 6 still pending review', color: '#005C8D' }],
  }),
  ...
  'Which ownership transfers affect active contracts?': c({
    ...
    stats: [{ label: 'Contract Impact', value: '4', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Renegotiation', value: '2', color: '#D97706', bg: '#FFF7ED' }, { label: 'Legal Review', value: '2', color: '#D97706', bg: '#FFF7ED' }, { label: 'Networks Hit', value: '5', color: '#005C8D', bg: '#E8F3F9' }],
    ...
    chatInsights: [{ icon: 'warning', text: '4 ownership changes affect active contracts', color: '#DC2626' }, { icon: 'info', text: 'Aetna, OptumRx, Humana networks impacted', color: '#005C8D' }],
  }),
  ...
  'List all CHOW events flagged as high priority': c({
    ...
    stats: [{ label: 'High Priority', value: '4', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Networks Affected', value: '11', color: '#D97706', bg: '#FFF7ED' }, { label: 'Avg Networks', value: '2.8', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Action Needed', value: 'Immediate', color: '#DC2626', bg: '#FEF2F2' }],
    ...
    chatInsights: [{ icon: 'warning', text: '4 high-priority CHOW events requiring action', color: '#DC2626' }, { icon: 'info', text: '11 network contracts affected total', color: '#005C8D' }],
  }),
  ...
  'Show ownership change history for Green Valley Pharmacy': c({
    ...
    stats: [{ label: 'Pharmacy', value: 'Green Valley', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Location', value: 'Seattle, WA', color: '#334155', bg: '#F8FAFC' }, { label: 'CHOW Events', value: '1', color: '#D97706', bg: '#FFF7ED' }, { label: 'Status', value: 'Processed', color: '#449055', bg: '#ECFDF5' }],
    barData: [{ label: '2024', value: 0 }, { label: '2025', value: 0 }, { label: '2026', value: 1 }], barLabel: 'CHOW History',
    pieData: [{ name: 'Processed', value: 1, color: '#449055' }], pieLabel: 'Status',
    ...
    chatInsights: [{ icon: 'info', text: '1 ownership change — Mar 5, 2026', color: '#005C8D' }, { icon: 'stat', text: 'New owner: Green Valley Healthcare Partners LLC', color: '#449055' }],
  }),
  ...
  'How many pharmacies changed ownership in Q1?': c({
    ...
    stats: [{ label: 'Q1 Total', value: '48', color: '#D97706', bg: '#FFF7ED' }, { label: 'March', value: '18', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Processed', value: '36', color: '#449055', bg: '#ECFDF5' }, { label: 'Pending', value: '12', color: '#D97706', bg: '#FFF7ED' }],
    barData: [{ label: 'Jan', value: 14 }, { label: 'Feb', value: 16 }, { label: 'Mar', value: 18 }], barLabel: 'Q1 CHOW by Month',
    pieData: [{ name: 'Processed', value: 36, color: '#449055' }, { name: 'Review', value: 8, color: '#F59E0B' }, { name: 'Pending', value: 4, color: '#DC2626' }], pieLabel: 'Q1 Status',
    ...
    chatInsights: [{ icon: 'stat', text: '48 ownership changes in Q1 2026', color: '#D97706' }, { icon: 'info', text: 'Historical total: 1,128 CHOW processed', color: '#005C8D' }],
  }),
  ...
  'Network adequacy breakdown by state': c({
    ...
    stats: [{ label: 'States OK', value: '44', color: '#449055', bg: '#ECFDF5' }, { label: 'Below 90%', value: '6', color: '#DC2626', bg: '#FEF2F2' }, { label: 'National', value: '94.2%', color: '#449055', bg: '#ECFDF5' }, { label: 'Pharmacies', value: '81,500', color: '#005C8D', bg: '#E8F3F9' }],
    ...
    pieData: [{ name: 'Exceeds', value: 28, color: '#449055' }, { name: 'Meets', value: 16, color: '#005C8D' }, { name: 'Below', value: 6, color: '#DC2626' }], pieLabel: 'Adequacy Distribution',
    ...
    chatInsights: [{ icon: 'stat', text: '44 of 50 states meet 90% threshold', color: '#449055' }, { icon: 'warning', text: '6 states below: MT, WV, AK, ND, WY, NM', color: '#DC2626' }],
  }),
  ...
  'Show pharmacy desert zones in the Southeast': c({
    ...
    stats: [{ label: 'Desert Zones', value: '12', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Critical', value: '3', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Population', value: '403K', color: '#D97706', bg: '#FFF7ED' }, { label: 'Pharmacies Needed', value: '16', color: '#005C8D', bg: '#E8F3F9' }],
    ...
    pieData: [{ name: 'Critical', value: 3, color: '#DC2626' }, { name: 'Moderate', value: 5, color: '#F59E0B' }, { name: 'Low', value: 4, color: '#005C8D' }], pieLabel: 'Severity Level',
  ...
  'How many pharmacies are in rural California counties?': c({
    ...
    stats: [{ label: 'Rural CA', value: '1,840', color: '#005C8D', bg: '#E8F3F9' }, { label: '% of CA', value: '18.2%', color: '#334155', bg: '#F8FAFC' }, { label: 'Kern County', value: '142', color: '#449055', bg: '#ECFDF5' }, { label: 'Rural Counties', value: '28', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Urban CA', value: 8280, color: '#005C8D' }, { name: 'Rural CA', value: 1840, color: '#76C799' }], pieLabel: 'Urban vs Rural (CA)',
    ...
    chatInsights: [{ icon: 'stat', text: '1,840 pharmacies in rural CA — 18.2% of state', color: '#005C8D' }, { icon: 'location', text: 'Kern County leads with 142 pharmacies', color: '#449055' }],
  }),
  ...
  'Map coverage gaps for my PBM network': c({
    ...
    stats: [{ label: 'Gap Zones', value: '8', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Critical', value: '3', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Moderate', value: '5', color: '#D97706', bg: '#FFF7ED' }, { label: 'Needed', value: '466', color: '#005C8D', bg: '#E8F3F9' }],
  ...
  'Download all active pharmacy records as CSV': c({
    ...
    stats: [{ label: 'Records', value: '81,500', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Format', value: 'CSV', color: '#449055', bg: '#ECFDF5' }, { label: 'File Size', value: '~210 MB', color: '#334155', bg: '#F8FAFC' }, { label: 'States', value: '50', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'Retail', value: 48200, color: '#005C8D' }, { name: 'Specialty', value: 18400, color: '#76C799' }, { name: 'LTC', value: 8900, color: '#F59E0B' }, { name: 'Other', value: 6000, color: '#94A3B8' }], pieLabel: 'Export by Type',
    ...
    chatInsights: [{ icon: 'stat', text: '81,500 pharmacy records ready', color: '#449055' }, { icon: 'info', text: 'CSV format, ~210 MB file size', color: '#005C8D' }],
  }),
  ...
  'Bulk export pharmacies in TX, FL, and CA': c({
    ...
    stats: [{ label: 'Total', value: '26,380', color: '#005C8D', bg: '#E8F3F9' }, { label: 'CA', value: '10,120', color: '#449055', bg: '#ECFDF5' }, { label: 'TX', value: '8,640', color: '#449055', bg: '#ECFDF5' }, { label: 'FL', value: '7,620', color: '#449055', bg: '#ECFDF5' }],
    barData: [{ label: 'CA', value: 10120 }, { label: 'TX', value: 8640 }, { label: 'FL', value: 7620 }], barLabel: 'Records by State',
    pieData: [{ name: 'CA', value: 10120, color: '#005C8D' }, { name: 'TX', value: 8640, color: '#76C799' }, { name: 'FL', value: 7620, color: '#F59E0B' }], pieLabel: 'State Distribution',
    ...
    chatInsights: [{ icon: 'stat', text: '26,380 pharmacies across TX, FL, CA', color: '#449055' }, { icon: 'info', text: 'CA: 10,120 · TX: 8,640 · FL: 7,620', color: '#005C8D' }],
  }),
  ...
  'How many records were exported today?': c({
    ...
    stats: [{ label: 'Exports Today', value: '3', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Records', value: '24,600', color: '#449055', bg: '#ECFDF5' }, { label: 'Total Size', value: '48.2 MB', color: '#334155', bg: '#F8FAFC' }, { label: 'Formats', value: 'CSV, JSON', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'CSV', value: 2, color: '#005C8D' }, { name: 'JSON', value: 1, color: '#76C799' }], pieLabel: 'Format',
    ...
    chatInsights: [{ icon: 'stat', text: '3 batch exports completed today', color: '#449055' }, { icon: 'info', text: '24,600 records in CSV and JSON', color: '#005C8D' }],
  }),
  ...
  'Schedule a weekly batch download of chain pharmacies': c({
    ...
    stats: [{ label: 'Schedule', value: 'Weekly', color: '#449055', bg: '#ECFDF5' }, { label: 'Day', value: 'Monday', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Records', value: '~34,200', color: '#334155', bg: '#F8FAFC' }, { label: 'Delivery', value: 'SFTP', color: '#334155', bg: '#F8FAFC' }],
    ...
    pieData: [{ name: 'CVS', value: 9800, color: '#DC2626' }, { name: 'Walgreens', value: 8600, color: '#005C8D' }, { name: 'Rite Aid', value: 4200, color: '#76C799' }, { name: 'Other', value: 11600, color: '#94A3B8' }], pieLabel: 'Chain Distribution',
    ...
    chatInsights: [{ icon: 'stat', text: 'Scheduled: Monday 6 AM ET weekly', color: '#449055' }, { icon: 'info', text: '~34,200 chain pharmacy records per export', color: '#005C8D' }],
  }),
  ...
  'Export pharmacy demographics with custom field selection': c({
    ...
    stats: [{ label: 'Records', value: '81,500', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Fields', value: '12', color: '#449055', bg: '#ECFDF5' }, { label: 'Formats', value: 'CSV/JSON', color: '#334155', bg: '#F8FAFC' }, { label: 'Custom', value: 'Yes', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'Complete', value: 68400, color: '#449055' }, { name: 'Partial', value: 11200, color: '#F59E0B' }, { name: 'Minimal', value: 1900, color: '#DC2626' }], pieLabel: 'Profile Completeness',
    ...
    chatInsights: [{ icon: 'stat', text: '81,500 records with 12 demographic fields', color: '#449055' }, { icon: 'info', text: 'Choose fields: name, address, phone, hours, services, etc.', color: '#005C8D' }],
  }),
  ...
  'Show pharmacies that attested FWA in the last 30 days': c({
    ...
    stats: [{ label: 'Last 30 Days', value: '4,218', color: '#449055', bg: '#ECFDF5' }, { label: 'TX', value: '612', color: '#005C8D', bg: '#E8F3F9' }, { label: 'CA', value: '548', color: '#005C8D', bg: '#E8F3F9' }, { label: 'Overall Rate', value: '90%', color: '#449055', bg: '#ECFDF5' }],
    ...
    pieData: [{ name: 'Attested', value: 73350, color: '#449055' }, { name: 'Pending', value: 6480, color: '#F59E0B' }, { name: 'Not Started', value: 1670, color: '#DC2626' }], pieLabel: 'FWA Status',
    ...
    chatInsights: [{ icon: 'stat', text: '4,218 pharmacies attested in last 30 days', color: '#449055' }, { icon: 'info', text: 'TX: 612, CA: 548, FL: 441', color: '#005C8D' }],
  }),
  ...
  'List independent pharmacies missing FWA attestation for 2025': c({
    ...
    pieData: [{ name: 'Attested 2025', value: 23030, color: '#449055' }, { name: 'Missing 2025', value: 1420, color: '#DC2626' }], pieLabel: '2025 Attestation',
    ...
    chatInsights: [{ icon: 'warning', text: '1,420 independents missing 2025 FWA', color: '#DC2626' }, { icon: 'location', text: 'TX: 218, CA: 186, FL: 154', color: '#005C8D' }],
  }),
  ...
  'Which independent pharmacies have not completed FWA attestation for 2026?': c({
    ...
    pieData: [{ name: 'Attested', value: 73350, color: '#449055' }, { name: 'Pending', value: 6480, color: '#F59E0B' }, { name: 'Not Started', value: 1670, color: '#DC2626' }], pieLabel: '2026 Status',
    ...
    chatInsights: [{ icon: 'warning', text: '8,150 independents missing 2026 FWA', color: '#DC2626' }, { icon: 'location', text: 'TX: 1,220 · CA: 980 · FL: 840', color: '#005C8D' }],
  }),
  ...
  'Show all critical alerts requiring action': c({
    ...
    stats: [{ label: 'Active Alerts', value: '2', color: '#D97706', bg: '#FFF7ED' }, { label: 'Critical', value: '0', color: '#449055', bg: '#ECFDF5' }, { label: 'Warnings', value: '2', color: '#D97706', bg: '#FFF7ED' }, { label: 'Status', value: 'Pending', color: '#D97706', bg: '#FFF7ED' }],
    ...
    chatInsights: [{ icon: 'warning', text: '2 subscriptions nearing expiration', color: '#D97706' }, { icon: 'stat', text: 'No critical compliance violations detected', color: '#449055' }],
  }),
  ...
  'Run FWA attestation status check': c({
    ...
    stats: [{ label: 'Attested', value: '73,350', color: '#449055', bg: '#ECFDF5' }, { label: 'Pending', value: '6,480', color: '#D97706', bg: '#FFF7ED' }, { label: 'Not Started', value: '1,670', color: '#DC2626', bg: '#FEF2F2' }, { label: 'Rate', value: '90%', color: '#449055', bg: '#ECFDF5' }],
    ...
    chatInsights: [{ icon: 'stat', text: '73,350 of 81,500 (90%) attested for 2026', color: '#449055' }, { icon: 'warning', text: '8,150 still pending — TX: 1,220 missing', color: '#D97706' }],
  }),
};
