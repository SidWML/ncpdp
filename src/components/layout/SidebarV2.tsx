...
import {
  ...
  IconGlobe, IconStore, IconDownload, IconLogoBrain,
...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/ai-search',  label: 'AI Smart Search',  icon: IconLogoBrain },
      { href: '/ai-reports', label: 'AI Report Builder', icon: IconReport },
