...
export function TopbarV2({ title, subtitle, actions }: Props) {
  return (
    <header style={{
      ...
      <div style={{ width: 32, height: 32, borderRadius: 9, background: 'linear-gradient(135deg,#005C8D,#005C8D)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 700, color: '#fff', flexShrink: 0, cursor: 'pointer' }}>SC</div>
    </header>
  );
}
