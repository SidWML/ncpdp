// Mock data for DataSolutions.ai dashboard demo
...
export const credentialStatus = [
  { label: 'Active',    value: 73350, color: '#76C799', pct: 90.0 },
...
export const pharmacyProfiles: Record<string, PharmacyProfile> = {
  'NCP-001': {
    ...
    changes: [
      ...
      { date: 'Feb 15, 2026', type: 'Update',     desc: 'Phone number updated via resQ portal by pharmacy administrator', color: '#005C8D' },
  ...
  'NCP-002': {
    ...
    changes: [
      ...
      { date: 'Mar 10, 2026', type: 'Update',     desc: 'Operating hours updated: extended Saturday hours added',         color: '#005C8D' },
      { date: 'Jan 22, 2026', type: 'Credential', desc: 'FWA Attestation renewed for 2026',                              color: '#76C799' },
    ],
  },
  'NCP-003': {
    ...
    changes: [
      ...
      { date: 'Mar 1, 2026',  type: 'Update',     desc: 'Added Specialty Drugs service capability to profile',               color: '#005C8D' },
      { date: 'Dec 18, 2025', type: 'Credential', desc: 'ACHC accreditation renewed — valid through Dec 2026',               color: '#76C799' },
      { date: 'Oct 5, 2025',  type: 'Network',    desc: 'Added to Prime Therapeutics specialty drug network',                color: '#76C799' },
    ],
  },
  'NCP-004': {
    ...
    changes: [
      { date: 'Mar 20, 2026', type: 'Credential', desc: 'Annual ACHC accreditation review — passed with commendation',    color: '#76C799' },
      { date: 'Feb 8, 2026',  type: 'Network',    desc: 'Added to Humana oncology specialty drug network',                color: '#76C799' },
      { date: 'Jan 15, 2026', type: 'Update',     desc: 'Rare Disease service capability added to profile',               color: '#005C8D' },
      { date: 'Nov 1, 2025',  type: 'Ownership',  desc: 'Partial ownership transfer — Sunrise Health Solutions LLC (80%)', color: '#004870' },
    ],
  },
  'NCP-005': {
    ...
    changes: [
      { date: 'Mar 5, 2026',  type: 'Ownership',  desc: 'Change of ownership — Green Valley Healthcare Partners LLC',   color: '#004870' },
      { date: 'Feb 20, 2026', type: 'Credential', desc: 'FWA Attestation renewed for 2026 — submitted via portal',      color: '#76C799' },
      { date: 'Jan 12, 2026', type: 'Update',     desc: 'Sunday hours added: 11AM–5PM',                                 color: '#005C8D' },
    ],
  },
  'NCP-006': {
    ...
    changes: [
      ...
      { date: 'Feb 1, 2026',  type: 'Network',    desc: 'Added to OptumRx oncology specialty compounding network',       color: '#76C799' },
      { date: 'Jan 20, 2026', type: 'Update',     desc: 'Veterinary Compounding service added to profile',               color: '#005C8D' },
    ],
  },
  'NCP-007': {
    ...
    changes: [
      { date: 'Mar 10, 2026', type: 'Update',     desc: 'Extended hours — now open 7 days/week 8AM–10PM',               color: '#005C8D' },
      { date: 'Feb 14, 2026', type: 'Credential', desc: 'FWA Attestation renewed for 2026',                              color: '#76C799' },
      { date: 'Dec 1, 2025',  type: 'Network',    desc: 'Added Point-of-Care Testing certification',                     color: '#76C799' },
    ],
  },
  'NCP-008': {
    ...
    changes: [
      ...
      { date: 'Feb 28, 2026', type: 'Credential', desc: 'FWA Attestation renewed for 2026 — LTC exemption applied',               color: '#76C799' },
      { date: 'Jan 5, 2026',  type: 'Network',    desc: 'LTC network adequacy review — passed all criteria',                  color: '#76C799' },
    ],
  },
};
